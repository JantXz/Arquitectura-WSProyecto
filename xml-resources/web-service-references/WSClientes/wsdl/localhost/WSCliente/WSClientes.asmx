...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/WSCliente/WSClientes.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WSClientes</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="WSClientes.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WSClientes.asmx?op=EliminarCliente">EliminarCliente</a>
              ...
              <li>
                <a href="WSClientes.asmx?op=InsertarCliente">InsertarCliente</a>

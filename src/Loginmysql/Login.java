...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Button_Close.setBackground(new java.awt.Color(255, 0, 51));
        ...
        B_Close.add(Button_Close, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 20));

        BarraTitulo.add(B_Close, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 20, 20));

        B_Min.setBackground(new java.awt.Color(107, 207, 107));
        ...
        B_Min.add(Button_Minimize, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 20));

        BarraTitulo.add(B_Min, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 20, 20));

        jLabel1.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel1.setText("ABARROTES \"CHAYO\"");
        ...
        TITULO1.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        TITULO1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        TITULO1.setText("BIENVENIDO!");
        PanelPrincipal.add(TITULO1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 500, 40));
